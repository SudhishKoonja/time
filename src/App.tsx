...
const EntryList = ({ entries, onDelete }: { entries: Entry[], onDelete: (id: string) => void }) => {
  if (entries.length === 0) {
    return (
...
const Timetable = ({ entries, theme, font, spacing }: { entries: Entry[], theme: Theme, font: typeof FONTS[0], spacing: typeof SPACING[0] }) => {
  return (
    <table 
      className={`w-full border-collapse ${spacing.fontSize} leading-relaxed`}
...
export default function App() {
  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans overflow-hidden">
      ...
      <div className="w-[400px] bg-white border-r border-gray-200 flex flex-col no-print z-10 shadow-xl shrink-0">
        <div className="p-5 border-b border-gray-200 bg-white flex justify-between items-center sticky top-0 z-20">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Create printable A4 schedules</p>
          </div>
      ...
      {/* Preview Area */}
      <div className="flex-1 overflow-y-auto p-8 flex justify-center print-container bg-gray-100/80 items-start">
        <div ref={printRef} className="bg-white shadow-2xl a4-page print-area relative">
          <Timetable 
